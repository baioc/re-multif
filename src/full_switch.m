...
% ========================== MODEL REACTION RATES ==============================
    ...
    Kr_R2P1_2 = 4e-6; % Switch unique variables
    Kr_R4P2_2 = 4e-6; % Switch unique variables
    Kr_R3P3_2 = 4e-6; % Switch unique variables
    Kr_R3P4_2 = 4e-6; % Switch unique variables
    Kr_R4P4_2 = 4e-6; % Switch unique variables
    Kr_R1P5_2 = 4e-6; % Switch unique variables
    Kr_R1P6_2 = 4e-6; % Switch unique variables
    Kr_R2P6_2 = 4e-6; % Switch unique variables
        ...
        for t = 1 : length(simulation)
            ...
            if s == 1 || s == 3
                ...
                if t >= 2500 && t <= 2584
                    ...
                    dmR1P1dt = Kc_P1 + Kb_P1 * (IsP1 / (Ka_P1 + IsP1)) * (1 / (1 + (R2^Nr_R2P1 / Kr_R2P1_2))) - Kd_mR1P1 * mR1P1;
                    dmR4P1dt = Kc_P1 + Kb_P1 * (IsP1 / (Ka_P1 + IsP1)) * (1 / (1 + (R2^Nr_R2P1 / Kr_R2P1_2))) - Kd_mR4P1 * mR4P1;
                    dmR2P2dt = Kc_P2 + Kb_P2 * (IsP2 / (Ka_P2 + IsP2)) * (1 / (1 + (R4^Nr_R4P2 / Kr_R4P2))) - Kd_mR2P2 * mR2P2;
                    dmR3P2dt = Kc_P2 + Kb_P2 * (IsP2 / (Ka_P2 + IsP2)) * (1 / (1 + (R4^Nr_R4P2 / Kr_R4P2))) - Kd_mR3P2 * mR3P2;
                    ...
                    dmR3P5dt = Kc_P5 + Kb_P5 * (1 / (1 + (R1^Nr_R1P5 / Kr_R1P5_2))) - Kd_mR3P5 * mR3P5;
                    dmR4P6dt = Kc_P6 + Kb_P6 * (1 / (1 + (R1^Nr_R1P6 / Kr_R1P6_2))) * (1 / (1 + (R2^Nr_R2P6 / Kr_R2P6_2))) - Kd_mR4P6 * mR4P6;

                else

                    dmR1P1dt = Kc_P1 + Kb_P1 * (IsP1 / (Ka_P1 + IsP1)) * (1 / (1 + (R2^Nr_R2P1 / Kr_R2P1))) - Kd_mR1P1 * mR1P1;
                    dmR4P1dt = Kc_P1 + Kb_P1 * (IsP1 / (Ka_P1 + IsP1)) * (1 / (1 + (R2^Nr_R2P1 / Kr_R2P1))) - Kd_mR4P1 * mR4P1;
                    dmR2P2dt = Kc_P2 + Kb_P2 * (IsP2 / (Ka_P2 + IsP2)) * (1 / (1 + (R4^Nr_R4P2 / Kr_R4P2))) - Kd_mR2P2 * mR2P2;
                    dmR3P2dt = Kc_P2 + Kb_P2 * (IsP2 / (Ka_P2 + IsP2)) * (1 / (1 + (R4^Nr_R4P2 / Kr_R4P2))) - Kd_mR3P2 * mR3P2;
                    dmR1P3dt = Kc_P3 + Kb_P3 * (1 / (1 + (R3^Nr_R3P3 / Kr_R3P3))) - Kd_mR1P3 * mR1P3;
                    dmR2P4dt = Kc_P4 + Kb_P4 * (1 / (1 + (R3^Nr_R3P4 / Kr_R3P4))) * (1 / (1 + (R4^Nr_R4P4 / Kr_R4P4))) - Kd_mR2P4 * mR2P4;
                ...
                if t >= 2500 && t <= 2584
                    ...
                    dmR1P1dt = Kc_P1 + Kb_P1 * (IsP1 / (Ka_P1 + IsP1)) * (1 / (1 + (R2^Nr_R2P1 / Kr_R2P1))) - Kd_mR1P1 * mR1P1;
                    dmR4P1dt = Kc_P1 + Kb_P1 * (IsP1 / (Ka_P1 + IsP1)) * (1 / (1 + (R2^Nr_R2P1 / Kr_R2P1))) - Kd_mR4P1 * mR4P1;
                    dmR2P2dt = Kc_P2 + Kb_P2 * (IsP2 / (Ka_P2 + IsP2)) * (1 / (1 + (R4^Nr_R4P2 / Kr_R4P2_2))) - Kd_mR2P2 * mR2P2;
                    dmR3P2dt = Kc_P2 + Kb_P2 * (IsP2 / (Ka_P2 + IsP2)) * (1 / (1 + (R4^Nr_R4P2 / Kr_R4P2_2))) - Kd_mR3P2 * mR3P2;
                    dmR1P3dt = Kc_P3 + Kb_P3 * (1 / (1 + (R3^Nr_R3P3 / Kr_R3P3_2))) - Kd_mR1P3 * mR1P3;
                    dmR2P4dt = Kc_P4 + Kb_P4 * (1 / (1 + (R3^Nr_R3P4 / Kr_R3P4_2))) * (1 / (1 + (R4^Nr_R4P4 / Kr_R4P4_2))) - Kd_mR2P4 * mR2P4;
                    dmR3P5dt = Kc_P5 + Kb_P5 * (1 / (1 + (R1^Nr_R1P5 / Kr_R1P5))) - Kd_mR3P5 * mR3P5;
                    dmR4P6dt = Kc_P6 + Kb_P6 * (1 / (1 + (R1^Nr_R1P6 / Kr_R1P6))) * (1 / (1 + (R2^Nr_R2P6 / Kr_R2P6))) - Kd_mR4P6 * mR4P6;
