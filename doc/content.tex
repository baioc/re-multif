...
\section{Results}
  ...
  \subsection{Frequency Divider}
    ...
    This suggests \acs{mrna} reactions stabilize quicker in the first $1 \times 10^5$ seconds and thus the approximation is more accurate at those instants.
  ...
  \subsection{Bifurcation Analysis}
    ...
    \subsubsection{Self-induced Oscillator}
