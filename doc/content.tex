% \subsection*{Abstract}
  ...
  % We reproduce their simulations and include new experiments to explore parameter space. % @XXX: not yet
...
\section{Results}
  ...
  \subsection{Frequency Divider}
    ...
    These diverge from the reference work, where it is stated that this threshold could be observed at input periods of $\sim 27500$ seconds ($\sim 8$ hours). % @XXX: same on QSSA?
    ...
    \begin{figure}[!htb]
      \centering
      \includegraphics[width=0.8\textwidth]{freqdiv-period}
  ...
  \subsection{Bifurcation Analysis}
    ...
    \begin{figure}[!htb]
      \centering
      \includegraphics[width=0.5\textwidth]{bifurcation-3}
  ...
  \subsection{Self-induced Oscillator}
    ...
    This is presented in Figure \ref{fig.oscillator-astable}. % @XXX: same on QSSA?

    \begin{figure}[!htb]
      \centering
      \includegraphics[width=0.65\textwidth]{oscillator-astable}
