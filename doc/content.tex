...
\section{Results}
  ...
  \subsection{Frequency Divider}
    ...
    \texit{@FAVARIN: testar a resposta em frequência do modelo operando como divisor de frequencia.
  ...
  \subsection{Self-induced Oscillator}
    ...
    \texit{@FAVARIN: testar a resposta em frequência do modelo operando como oscilador.
  ...
  \subsection{Promoter Leakiness}
    ...
    \texit{@FAVARIN: testar a robustez dos diferentes modos de operação da rede.
    Isso será feito adicionando aos sistemas de EDOs a taxa basal mencionada no livro do Ingalls, seção 7.1.2
    Para valor numérico, ver artigo original do repressilator.}
