...
\section{Results}
  ...
  \subsection{Bifurcation Analysis}
    ...
    Other experiments do not present such significant offset. % @XXX: really? confirm with actual data
  ...
  \subsection{Toggle Switch}
    ...
    This set of experiments were exactly reproduced and no significant difference is found between reduced and full models. % @XXX: again, show this comparison data

    % @FIXME: toggle switch function must be tested from non-pristine (previously used) states
